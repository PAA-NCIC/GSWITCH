...
struct config_t{
  void dump(std::ostream& out = std::cout){
    ...
    switch(conf_lb){
      case TM : out <<"TM"<<" "; break;
      case WM : out <<"WM"<<" "; break;
      case CM : out <<"CM"<<" "; break;
      case STRICT: out << "STRICT" << " "; break;
      case TWOD  : std::cout << "2D-partition"; break;
      case ELB   : out << "ELB"; break;
      case TWC: out <<"TWC"<< " "; break;
  ...
  void show_hints(){
    ...
    switch(conf_lb){
      case TM:  std::cout << "TM"; break;
      case WM:  std::cout << "WM"; break;
      case CM:  std::cout << "CM"; break;
      case STRICT: std::cout << "STRICT"; break;
      case TWOD  : std::cout << "2D-partition"; break;
      case ELB   : std::cout << "ELB"; break;
      case TWC: std::cout << "TWC"; break;
  ...
  bool ignore_u_state(){return conf_ignore_u_state;}

  __device__ __forceinline__
  Status want(){return conf_target;}

  __device__ __forceinline__
  bool pruning() {return conf_pruning;}

  __device__ __forceinline__
  bool fuse_inspect() {return conf_fuse_inspect;}
